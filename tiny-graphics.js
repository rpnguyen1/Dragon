  ...
  class Component {
      ...
      make_context (canvas, background_color = color (0, 0, 0, 1), dimensions) {
        ...
        //   gl.clearColor.apply (gl, background_color);
          gl.clearColor.apply (gl, this.settings.backgroundColor);
      ...
      frame_advance (time = 0) {
          if ( !this.props.dont_tick) {
            ...
            if (time - this.last_fps_update >= 1000) {
                this.fps = this.frame_count;
                this.frame_count = 0; // Reset frame count for the next second
                this.last_fps_update = time;

                // Display the FPS in the console or UI
      ...
      live_html (htmlContent, parent = this.control_panel) {
        const div = document.createElement("div");
        div.innerHTML = htmlContent;  // Insert raw HTML into the div
